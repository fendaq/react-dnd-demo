...
class TargetBox extends BaseComponent {
      ...
      return (
        ...
        >
          ...
          >
            ...
            >
              {children && children.length ? this.layoutRender(children) : null}
            </Component>
  ...
  render() {
    const { connectDropTarget, layoutTree } = this.props;

    return connectDropTarget(
      <div className="form-designer__preview">
        <Form>{this.layoutRender(layoutTree)}</Form>
      </div>
    );
  }
}
